...
SOAP_SOURCE_STAMP("@(#) quoteC.c ver 2.8.8 2012-04-18 14:36:19 GMT")
...
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getQuote), type))
		return soap->error;
...
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getQuoteResponse), type))
		return soap->error;
