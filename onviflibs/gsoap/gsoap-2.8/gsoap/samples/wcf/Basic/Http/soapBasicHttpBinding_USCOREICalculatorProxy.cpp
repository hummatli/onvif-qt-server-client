...
int BasicHttpBinding_USCOREICalculatorProxy::Add(const char *endpoint, const char *soap_action, _mssamh__Add *mssamh__Add, _mssamh__AddResponse *mssamh__AddResponse)
{	struct soap *soap = this->soap;
	...
	if (soap_action == NULL)
		soap_action = "http://Microsoft.Samples.Http/ICalculator/Add";
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___tempuri__Add.mssamh__Add = mssamh__Add;
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	mssamh__AddResponse->soap_get(soap, "mssamh:AddResponse", "");
	if (soap->error)
...
int BasicHttpBinding_USCOREICalculatorProxy::Subtract(const char *endpoint, const char *soap_action, _mssamh__Subtract *mssamh__Subtract, _mssamh__SubtractResponse *mssamh__SubtractResponse)
{	struct soap *soap = this->soap;
	...
	if (soap_endpoint == NULL)
		soap_endpoint = "http://192.168.2.2:8000/ServiceModelSamples/service";
	if (soap_action == NULL)
		soap_action = "http://Microsoft.Samples.Http/ICalculator/Subtract";
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___tempuri__Subtract.mssamh__Subtract = mssamh__Subtract;
	soap_serializeheader(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	mssamh__SubtractResponse->soap_get(soap, "mssamh:SubtractResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int BasicHttpBinding_USCOREICalculatorProxy::Multiply(const char *endpoint, const char *soap_action, _mssamh__Multiply *mssamh__Multiply, _mssamh__MultiplyResponse *mssamh__MultiplyResponse)
{	struct soap *soap = this->soap;
	...
	if (soap_endpoint == NULL)
		soap_endpoint = "http://192.168.2.2:8000/ServiceModelSamples/service";
	if (soap_action == NULL)
		soap_action = "http://Microsoft.Samples.Http/ICalculator/Multiply";
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___tempuri__Multiply.mssamh__Multiply = mssamh__Multiply;
	soap_serializeheader(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	mssamh__MultiplyResponse->soap_get(soap, "mssamh:MultiplyResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int BasicHttpBinding_USCOREICalculatorProxy::Divide(const char *endpoint, const char *soap_action, _mssamh__Divide *mssamh__Divide, _mssamh__DivideResponse *mssamh__DivideResponse)
{	struct soap *soap = this->soap;
	...
	if (soap_endpoint == NULL)
		soap_endpoint = "http://192.168.2.2:8000/ServiceModelSamples/service";
	if (soap_action == NULL)
		soap_action = "http://Microsoft.Samples.Http/ICalculator/Divide";
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___tempuri__Divide.mssamh__Divide = mssamh__Divide;
	soap_serializeheader(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	mssamh__DivideResponse->soap_get(soap, "mssamh:DivideResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
