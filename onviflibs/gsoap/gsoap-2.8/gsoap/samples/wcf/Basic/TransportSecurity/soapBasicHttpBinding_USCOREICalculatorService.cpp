...
{	BasicHttpBinding_USCOREICalculatorService_init(this->soap->imode, this->soap->omode);
	...
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "mssamt:Add")) || (this->soap->action && !strcmp(this->soap->action, "http://Microsoft.Samples.TransportSecurity/ICalculator/Add")))
		return serve___tempuri__Add(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "mssamt:Subtract")) || (this->soap->action && !strcmp(this->soap->action, "http://Microsoft.Samples.TransportSecurity/ICalculator/Subtract")))
		return serve___tempuri__Subtract(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "mssamt:Multiply")) || (this->soap->action && !strcmp(this->soap->action, "http://Microsoft.Samples.TransportSecurity/ICalculator/Multiply")))
		return serve___tempuri__Multiply(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "mssamt:Divide")) || (this->soap->action && !strcmp(this->soap->action, "http://Microsoft.Samples.TransportSecurity/ICalculator/Divide")))
